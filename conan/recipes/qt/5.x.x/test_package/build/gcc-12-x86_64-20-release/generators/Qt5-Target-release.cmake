...
set_property(TARGET qt_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:ZLIB::ZLIB;pcre2::pcre2;double-conversion::double-conversion;zstd::libzstd_shared;Freetype::Freetype;PNG::PNG;opengl::opengl;JPEG::JPEG;md4c::md4c-html;Qt5::Core;Qt5::Gui;Qt5::Widgets;Qt5::EventDispatcherSupport;Qt5::FontDatabaseSupport;Qt5::ThemeSupport;Qt5::AccessibilitySupport;Qt5::WindowsUIAutomationSupport;SQLite::SQLite3;PostgreSQL::PostgreSQL;openssl::openssl;Qt5::UiPlugin;Qt5::Xml;Qt5::Sql>)
...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT Qt5::Charts #############

        set(qt_Qt5_Charts_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(qt_Qt5_Charts_FRAMEWORKS_FOUND_RELEASE "${qt_Qt5_Charts_FRAMEWORKS_RELEASE}" "${qt_Qt5_Charts_FRAMEWORK_DIRS_RELEASE}")

        set(qt_Qt5_Charts_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET qt_Qt5_Charts_DEPS_TARGET)
            add_library(qt_Qt5_Charts_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET qt_Qt5_Charts_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt5_Charts_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt5_Charts_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt5_Charts_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'qt_Qt5_Charts_DEPS_TARGET' to all of them
        conan_package_library_targets("${qt_Qt5_Charts_LIBS_RELEASE}"
                              "${qt_Qt5_Charts_LIB_DIRS_RELEASE}"
                              "${qt_Qt5_Charts_BIN_DIRS_RELEASE}" # package_bindir
                              "${qt_Qt5_Charts_LIBRARY_TYPE_RELEASE}"
                              "${qt_Qt5_Charts_IS_HOST_WINDOWS_RELEASE}"
                              qt_Qt5_Charts_DEPS_TARGET
                              qt_Qt5_Charts_LIBRARIES_TARGETS
                              "_RELEASE"
                              "qt_Qt5_Charts"
                              "${qt_Qt5_Charts_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Qt5::Charts
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt5_Charts_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt5_Charts_LIBRARIES_TARGETS}>
                     )

        if("${qt_Qt5_Charts_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Qt5::Charts
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET Qt5::Charts APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt5_Charts_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET Qt5::Charts APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt5_Charts_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET Qt5::Charts APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt5_Charts_LIB_DIRS_RELEASE}>)
        set_property(TARGET Qt5::Charts APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${qt_Qt5_Charts_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET Qt5::Charts APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt5_Charts_COMPILE_OPTIONS_RELEASE}>)
    ...
    ########## COMPONENT Qt5::SerialPort #############

        set(qt_Qt5_SerialPort_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(qt_Qt5_SerialPort_FRAMEWORKS_FOUND_RELEASE "${qt_Qt5_SerialPort_FRAMEWORKS_RELEASE}" "${qt_Qt5_SerialPort_FRAMEWORK_DIRS_RELEASE}")

        set(qt_Qt5_SerialPort_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET qt_Qt5_SerialPort_DEPS_TARGET)
            add_library(qt_Qt5_SerialPort_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET qt_Qt5_SerialPort_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt5_SerialPort_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt5_SerialPort_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt5_SerialPort_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'qt_Qt5_SerialPort_DEPS_TARGET' to all of them
        conan_package_library_targets("${qt_Qt5_SerialPort_LIBS_RELEASE}"
                              "${qt_Qt5_SerialPort_LIB_DIRS_RELEASE}"
                              "${qt_Qt5_SerialPort_BIN_DIRS_RELEASE}" # package_bindir
                              "${qt_Qt5_SerialPort_LIBRARY_TYPE_RELEASE}"
                              "${qt_Qt5_SerialPort_IS_HOST_WINDOWS_RELEASE}"
                              qt_Qt5_SerialPort_DEPS_TARGET
                              qt_Qt5_SerialPort_LIBRARIES_TARGETS
                              "_RELEASE"
                              "qt_Qt5_SerialPort"
                              "${qt_Qt5_SerialPort_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Qt5::SerialPort
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt5_SerialPort_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt5_SerialPort_LIBRARIES_TARGETS}>
                     )

        if("${qt_Qt5_SerialPort_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Qt5::SerialPort
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET Qt5::SerialPort APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt5_SerialPort_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET Qt5::SerialPort APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt5_SerialPort_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET Qt5::SerialPort APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt5_SerialPort_LIB_DIRS_RELEASE}>)
        set_property(TARGET Qt5::SerialPort APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${qt_Qt5_SerialPort_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET Qt5::SerialPort APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt5_SerialPort_COMPILE_OPTIONS_RELEASE}>)
    ...
    set_property(TARGET qt::qt APPEND PROPERTY INTERFACE_LINK_LIBRARIES Qt5::Charts)
    ...
    set_property(TARGET qt::qt APPEND PROPERTY INTERFACE_LINK_LIBRARIES Qt5::SerialPort)
