...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT zstd::libzstd_shared #############
        ...
        set_property(TARGET zstd::libzstd_shared APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${zstd_zstd_libzstd_shared_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET zstd::libzstd_shared APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${zstd_zstd_libzstd_shared_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET zstd::libzstd_shared APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${zstd_zstd_libzstd_shared_LIB_DIRS_RELEASE}>)
        set_property(TARGET zstd::libzstd_shared APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${zstd_zstd_libzstd_shared_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET zstd::libzstd_shared APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${zstd_zstd_libzstd_shared_COMPILE_OPTIONS_RELEASE}>)


    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET zstd::libzstd_shared APPEND PROPERTY INTERFACE_LINK_LIBRARIES zstd::libzstd_shared)
