...
list(APPEND qt_COMPONENT_NAMES Qt5::Core Qt5::WinMain Qt5::LinguistTools Qt5::Gui Qt5::QSQLiteDriverPlugin Qt5::QPSQLDriverPlugin Qt5::Network Qt5::Sql Qt5::Test Qt5::Concurrent Qt5::Xml Qt5::SerialPort Qt5::EventDispatcherSupport Qt5::FontDatabaseSupport Qt5::ThemeSupport Qt5::AccessibilitySupport Qt5::Widgets Qt5::WindowsUIAutomationSupport Qt5::OpenGL Qt5::OpenGLExtensions Qt5::PrintSupport Qt5::QWindowsIntegrationPlugin Qt5::QWindowsVistaStylePlugin Qt5::UiPlugin Qt5::Help Qt5::Charts Qt5::UiTools Qt5::Designer)
...
if(DEFINED qt_FIND_DEPENDENCY_NAMES)
  ...
  set(qt_FIND_DEPENDENCY_NAMES OpenSSL PCRE2 double-conversion freetype JPEG PNG ZLIB SQLite3 PostgreSQL opengl_system zstd md4c)
endif()
...
########### VARIABLES #######################################################################
#############################################################################################
set(qt_PACKAGE_FOLDER_RELEASE "C:/WORKSPACE/conan/conan_home/p/b/qta9380fc5e8fff/p")
...
set(qt_LIBS_RELEASE Qt5Designer Qt5UiTools Qt5Charts Qt5Help Qt5PrintSupport Qt5OpenGLExtensions Qt5OpenGL Qt5WindowsUIAutomationSupport Qt5Widgets Qt5AccessibilitySupport Qt5ThemeSupport Qt5FontDatabaseSupport Qt5EventDispatcherSupport Qt5SerialPort Qt5Xml Qt5Concurrent Qt5Test Qt5Sql Qt5Network Qt5Gui qtmain Qt5Core)
set(qt_SYSTEM_LIBS_RELEASE advapi32 dwmapi gdi32 imm32 ole32 oleaut32 shell32 shlwapi user32 winmm winspool wtsapi32)
...
set(qt_BUILD_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/lib/cmake/Qt5Widgets"
			...
			"${qt_PACKAGE_FOLDER_RELEASE}/lib/cmake/Qt5LinguistTools"
...
set(qt_COMPONENTS_RELEASE Qt5::Core Qt5::WinMain Qt5::LinguistTools Qt5::Gui Qt5::QSQLiteDriverPlugin Qt5::QPSQLDriverPlugin Qt5::Network Qt5::Sql Qt5::Test Qt5::Concurrent Qt5::Xml Qt5::SerialPort Qt5::EventDispatcherSupport Qt5::FontDatabaseSupport Qt5::ThemeSupport Qt5::AccessibilitySupport Qt5::Widgets Qt5::WindowsUIAutomationSupport Qt5::OpenGL Qt5::OpenGLExtensions Qt5::PrintSupport Qt5::QWindowsIntegrationPlugin Qt5::QWindowsVistaStylePlugin Qt5::UiPlugin Qt5::Help Qt5::Charts Qt5::UiTools Qt5::Designer)
...
set(qt_Qt5_Designer_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_Designer_LIBRARY_TYPE_RELEASE SHARED)
...
set(qt_Qt5_UiTools_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_UiTools_LIBRARY_TYPE_RELEASE SHARED)
...
########### COMPONENT Qt5::Charts VARIABLES ############################################

set(qt_Qt5_Charts_INCLUDE_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/include"
			"${qt_PACKAGE_FOLDER_RELEASE}/include/QtCharts")
set(qt_Qt5_Charts_LIB_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/lib")
set(qt_Qt5_Charts_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_Charts_LIBRARY_TYPE_RELEASE SHARED)
set(qt_Qt5_Charts_IS_HOST_WINDOWS_RELEASE 1)
set(qt_Qt5_Charts_RES_DIRS_RELEASE )
set(qt_Qt5_Charts_DEFINITIONS_RELEASE "-DQT_CHARTS_LIB")
set(qt_Qt5_Charts_OBJECTS_RELEASE )
set(qt_Qt5_Charts_COMPILE_DEFINITIONS_RELEASE "QT_CHARTS_LIB")
set(qt_Qt5_Charts_COMPILE_OPTIONS_C_RELEASE "")
set(qt_Qt5_Charts_COMPILE_OPTIONS_CXX_RELEASE "")
set(qt_Qt5_Charts_LIBS_RELEASE Qt5Charts)
set(qt_Qt5_Charts_SYSTEM_LIBS_RELEASE )
set(qt_Qt5_Charts_FRAMEWORK_DIRS_RELEASE )
set(qt_Qt5_Charts_FRAMEWORKS_RELEASE )
set(qt_Qt5_Charts_DEPENDENCIES_RELEASE Qt5::Gui Qt5::Widgets Qt5::Core)
set(qt_Qt5_Charts_SHARED_LINK_FLAGS_RELEASE )
set(qt_Qt5_Charts_EXE_LINK_FLAGS_RELEASE )
set(qt_Qt5_Charts_NO_SONAME_MODE_RELEASE FALSE)

# COMPOUND VARIABLES
set(qt_Qt5_Charts_LINKER_FLAGS_RELEASE
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${qt_Qt5_Charts_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${qt_Qt5_Charts_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${qt_Qt5_Charts_EXE_LINK_FLAGS_RELEASE}>
)
set(qt_Qt5_Charts_COMPILE_OPTIONS_RELEASE
    "$<$<COMPILE_LANGUAGE:CXX>:${qt_Qt5_Charts_COMPILE_OPTIONS_CXX_RELEASE}>"
    "$<$<COMPILE_LANGUAGE:C>:${qt_Qt5_Charts_COMPILE_OPTIONS_C_RELEASE}>")
...
set(qt_Qt5_Help_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_Help_LIBRARY_TYPE_RELEASE SHARED)
...
set(qt_Qt5_UiPlugin_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_UiPlugin_LIBRARY_TYPE_RELEASE SHARED)
...
set(qt_Qt5_QWindowsVistaStylePlugin_LIB_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/plugins/styles")
set(qt_Qt5_QWindowsVistaStylePlugin_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_QWindowsVistaStylePlugin_LIBRARY_TYPE_RELEASE SHARED)
...
set(qt_Qt5_QWindowsVistaStylePlugin_LIBS_RELEASE )
...
set(qt_Qt5_QWindowsIntegrationPlugin_LIB_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/plugins/platforms")
set(qt_Qt5_QWindowsIntegrationPlugin_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_QWindowsIntegrationPlugin_LIBRARY_TYPE_RELEASE SHARED)
...
set(qt_Qt5_QWindowsIntegrationPlugin_LIBS_RELEASE )
...
set(qt_Qt5_WindowsUIAutomationSupport_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_WindowsUIAutomationSupport_LIBRARY_TYPE_RELEASE SHARED)
...
########### COMPONENT Qt5::SerialPort VARIABLES ############################################

set(qt_Qt5_SerialPort_INCLUDE_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/include"
			"${qt_PACKAGE_FOLDER_RELEASE}/include/QtSerialPort")
set(qt_Qt5_SerialPort_LIB_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/lib")
set(qt_Qt5_SerialPort_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_SerialPort_LIBRARY_TYPE_RELEASE SHARED)
set(qt_Qt5_SerialPort_IS_HOST_WINDOWS_RELEASE 1)
set(qt_Qt5_SerialPort_RES_DIRS_RELEASE )
set(qt_Qt5_SerialPort_DEFINITIONS_RELEASE "-DQT_SERIALPORT_LIB")
set(qt_Qt5_SerialPort_OBJECTS_RELEASE )
set(qt_Qt5_SerialPort_COMPILE_DEFINITIONS_RELEASE "QT_SERIALPORT_LIB")
set(qt_Qt5_SerialPort_COMPILE_OPTIONS_C_RELEASE "")
set(qt_Qt5_SerialPort_COMPILE_OPTIONS_CXX_RELEASE "")
set(qt_Qt5_SerialPort_LIBS_RELEASE Qt5SerialPort)
set(qt_Qt5_SerialPort_SYSTEM_LIBS_RELEASE )
set(qt_Qt5_SerialPort_FRAMEWORK_DIRS_RELEASE )
set(qt_Qt5_SerialPort_FRAMEWORKS_RELEASE )
set(qt_Qt5_SerialPort_DEPENDENCIES_RELEASE Qt5::Core)
set(qt_Qt5_SerialPort_SHARED_LINK_FLAGS_RELEASE )
set(qt_Qt5_SerialPort_EXE_LINK_FLAGS_RELEASE )
set(qt_Qt5_SerialPort_NO_SONAME_MODE_RELEASE FALSE)

# COMPOUND VARIABLES
set(qt_Qt5_SerialPort_LINKER_FLAGS_RELEASE
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${qt_Qt5_SerialPort_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${qt_Qt5_SerialPort_SHARED_LINK_FLAGS_RELEASE}>
        $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${qt_Qt5_SerialPort_EXE_LINK_FLAGS_RELEASE}>
)
set(qt_Qt5_SerialPort_COMPILE_OPTIONS_RELEASE
    "$<$<COMPILE_LANGUAGE:CXX>:${qt_Qt5_SerialPort_COMPILE_OPTIONS_CXX_RELEASE}>"
    "$<$<COMPILE_LANGUAGE:C>:${qt_Qt5_SerialPort_COMPILE_OPTIONS_C_RELEASE}>")
...
set(qt_Qt5_LinguistTools_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_LinguistTools_LIBRARY_TYPE_RELEASE SHARED)
...
set(qt_Qt5_WinMain_BIN_DIRS_RELEASE "${qt_PACKAGE_FOLDER_RELEASE}/bin")
set(qt_Qt5_WinMain_LIBRARY_TYPE_RELEASE SHARED)
...
set(qt_Qt5_Core_DEPENDENCIES_RELEASE ZLIB::ZLIB pcre2::pcre2 double-conversion::double-conversion zstd::libzstd_shared)
