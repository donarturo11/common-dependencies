...
set_property(TARGET glib_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:pcre2::pcre2;Intl::Intl;glib::glib-2.0;glib::gmodule-no-export-2.0;libffi::libffi;glib::gobject-2.0;glib::gmodule-2.0;ZLIB::ZLIB;glib::gio-2.0>)
...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT glib::gio-windows-2.0 #############

        set(glib_glib_gio-windows-2.0_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(glib_glib_gio-windows-2.0_FRAMEWORKS_FOUND_RELEASE "${glib_glib_gio-windows-2.0_FRAMEWORKS_RELEASE}" "${glib_glib_gio-windows-2.0_FRAMEWORK_DIRS_RELEASE}")

        set(glib_glib_gio-windows-2.0_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET glib_glib_gio-windows-2.0_DEPS_TARGET)
            add_library(glib_glib_gio-windows-2.0_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET glib_glib_gio-windows-2.0_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${glib_glib_gio-windows-2.0_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${glib_glib_gio-windows-2.0_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${glib_glib_gio-windows-2.0_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'glib_glib_gio-windows-2.0_DEPS_TARGET' to all of them
        conan_package_library_targets("${glib_glib_gio-windows-2.0_LIBS_RELEASE}"
                              "${glib_glib_gio-windows-2.0_LIB_DIRS_RELEASE}"
                              "${glib_glib_gio-windows-2.0_BIN_DIRS_RELEASE}" # package_bindir
                              "${glib_glib_gio-windows-2.0_LIBRARY_TYPE_RELEASE}"
                              "${glib_glib_gio-windows-2.0_IS_HOST_WINDOWS_RELEASE}"
                              glib_glib_gio-windows-2.0_DEPS_TARGET
                              glib_glib_gio-windows-2.0_LIBRARIES_TARGETS
                              "_RELEASE"
                              "glib_glib_gio-windows-2.0"
                              "${glib_glib_gio-windows-2.0_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET glib::gio-windows-2.0
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${glib_glib_gio-windows-2.0_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${glib_glib_gio-windows-2.0_LIBRARIES_TARGETS}>
                     )

        if("${glib_glib_gio-windows-2.0_LIBS_RELEASE}" STREQUAL "")
        ...
        set_property(TARGET glib::gio-windows-2.0 APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${glib_glib_gio-windows-2.0_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET glib::gio-windows-2.0 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${glib_glib_gio-windows-2.0_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET glib::gio-windows-2.0 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${glib_glib_gio-windows-2.0_LIB_DIRS_RELEASE}>)
        set_property(TARGET glib::gio-windows-2.0 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${glib_glib_gio-windows-2.0_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET glib::gio-windows-2.0 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${glib_glib_gio-windows-2.0_COMPILE_OPTIONS_RELEASE}>)
    ...
    set_property(TARGET glib::glib APPEND PROPERTY INTERFACE_LINK_LIBRARIES glib::gio-windows-2.0)
