...
class FreetypeConan(ConanFile):
    ...
    def package(self):
        ...
        if self.settings.os == "Windows" and is_msvc and self.options.shared and ver >= "2.13.0" and ver < "2.14.0":
            ...
            import glob
            candidates = glob.glob(os.path.join(self.package_folder, "bin", "*freetype-6.dll"))
            src = os.path.join(self.package_folder, "bin", candidates[0])
